...
<main class="container-xl d-flex justify-content-center align-items-center gap-3 mb-5 w-100">
    <section class="w-100 w-md-100 d-flex justify-content-center align-items-center gap-5 shadow">
        <form action="src/php/action/loginUser.php" class="m-5 d-flex flex-column w-100" method="post">
            <div class='mb-3'>
            ...
            <div class="mb-3 d-flex gap-2">
                ...
                <a class="btn w-25 fw-bold text-white text-center d-flex justify-content-center" style="background-color: #10A19D" href="<?=routes('cadastro')?>">Cadastro</a>
            </div>
        </form>
    </section>
    <section style="background-color: #10A19D" class="d-none d-xl-flex justify-content-center align-items-center gap-5 w-100 rounded pt-1 pb-1">
